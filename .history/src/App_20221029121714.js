...
function App() {
  return (
    <div className="App" style={{ }}>
      <div style={{ display: 'flex', marginTop: '20px',gap:'2rem',alignItems:"center",textAlign:"center" }}>
        <TextField
          type="datetime-local"
          label="Fecha Inicial"
          variant="outlined"
        ...
        />
         <Button  style={{ background:"yellow",color:'white' }}>
          Buscar</Button>
      ...
      <TableContainer style={{ width:'80%',alignItems:"center"}}>
